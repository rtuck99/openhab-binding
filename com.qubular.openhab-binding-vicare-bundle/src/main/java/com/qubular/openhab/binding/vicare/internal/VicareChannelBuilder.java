...
public class VicareChannelBuilder implements Supplier<VicareChannelBuilder.Memo> {
    ...
    private final VicareDeviceThingHandler thingHandler;

    public VicareChannelBuilder(VicareServiceProvider vicareServiceProvider, VicareUtil.IGD igd, Thing thing, VicareDeviceThingHandler thingHandler) {
    ...
    private Optional<ChannelBuilder> channelBuilder(ChannelUID channelUID,
        ...
        try {
            return channelTypeUID.map(ct -> thingHandler.createChannelBuilder(channelUID, ct));
    ...
    private Optional<ChannelType> createChannelType(Feature feature, ChannelType template, String channelId,
        ...
        if (channelType != null) {
            ...
            thingHandler.addChannelType(channelTypeUID, channelType);
        }
