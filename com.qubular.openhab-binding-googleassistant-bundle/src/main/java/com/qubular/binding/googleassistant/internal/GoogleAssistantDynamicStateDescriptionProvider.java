...
@Component(service = { DynamicStateDescriptionProvider.class,
        GoogleAssistantDynamicStateDescriptionProvider.class }, immediate = true)
public class GoogleAssistantDynamicStateDescriptionProvider implements DynamicStateDescriptionProvider {

    private final Map<ChannelUID, StateDescription> descriptions = new ConcurrentHashMap<>();
    private final Logger logger = LoggerFactory.getLogger(GoogleAssistantDynamicStateDescriptionProvider.class);
